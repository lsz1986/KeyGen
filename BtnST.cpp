...
/*
	m_crColors[BTNST_COLOR_BK_IN]		= QMS_BGCOLOR;
	m_crColors[BTNST_COLOR_FG_IN]		= RGB(0,0,255);
	m_crColors[BTNST_COLOR_BK_OUT]		= QMS_BGCOLOR;
	m_crColors[BTNST_COLOR_FG_OUT]		= RGB(0,0,255);
	m_crColors[BTNST_COLOR_BK_FOCUS]	= QMS_BGCOLOR;
	m_crColors[BTNST_COLOR_FG_FOCUS]	= RGB(0,0,255);
*/
	if (bRepaint)	Invalidate();
