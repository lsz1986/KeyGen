// CSysInfo.cpp: implementation of the CEthInfo class.
//
//////////////////////////////////////////////////////////////////////
...
#include "Iphlpapi.h"
#pragma comment(lib, "SysInfo\\Iphlpapi.lib")
...
void CSysInfo::GetMacAddr()
{
	...
	if (pAdapter)
	{
		...
		m_strEthMacAddr.Format("%.2X-%.2X-%.2X-%.2X-%.2X-%.2X",
...
void CSysInfo::GetHDSerial()
{
	...
	m_strHdSerial.Format(_T("%s"),m_HDSerial);
  return;
}

char* CSysInfo::DWORDToChar(DWORD diskdata[], int firstIndex, int lastIndex)
{
